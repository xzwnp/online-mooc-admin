<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column prop="price" label="封面" width="100">
        <template slot-scope="scope">
      ...
      <el-table-column prop="price" label="价格" width="80">
        <template slot-scope="scope">
          <span>{{ scope.row.price }} &nbsp 元</span>
        </template>
      </el-table-column>
      <el-table-column prop="buyCount" label="浏览数量" width="90"/>
      <el-table-column prop="viewCount" label="浏览数量" width="90"/>
      <el-table-column prop="gmtCreate" label="添加时间" width="160"/>
      <el-table-column prop="gmtModified" label="最后修改" width="160"/>
